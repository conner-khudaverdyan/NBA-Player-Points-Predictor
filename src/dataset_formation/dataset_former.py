...
from data_collection.get_player_data import get_player_data

from data_collection.get_factor_teammate_status import FactorTeammateFeatures
from data_collection.rolling_averages import RollingAverages
from data_collection.get_team_def_off_ratings import OffDefRatings
...
class DatasetFormer:
    ...
    def train_test_divide(self,date_of_game_to_split): 
        ...
        try: 
            date_of_game_to_split = self.dataset[self.dataset['GAME_DATE'] == date_of_game_to_split]['Game_ID'].index.tolist()[0]
        ...
        self.train_set = self.dataset.iloc[0:date_of_game_to_split,]
        self.test_set = self.dataset.iloc[date_of_game_to_split:,]
